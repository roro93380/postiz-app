...
export const Textarea = (props) => {
    ...
    return (<div className={clsx('flex flex-col gap-[6px]', props.disabled && 'opacity-50')}>
      ...
      <textarea {...(disableForm ? {} : form.register(props.name))} className={clsx('bg-input min-h-[150px] p-[16px] outline-none border-fifth border rounded-[10px] text-inputText placeholder-inputText transition-all duration-200 ease-out focus:border-accentSecondary focus:shadow-cyanGlow', className)} {...rest}/>
