...
export const Checkbox = forwardRef((props, ref) => {
    ...
    return (<div className="flex gap-[10px]">
      <div ref={ref} {...disableForm ? {} : form.register(props.name)} onClick={changeStatus} className={clsx('cursor-pointer rounded-[6px] select-none w-[24px] h-[24px] justify-center items-center flex text-white transition-all duration-200 ease-out', variant === 'default' || !variant
            ? 'bg-forth'
