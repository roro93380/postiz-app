...
import { showMediaBox } from "../media/media.component";
...
import { TeamsComponent } from "../settings/teams.component";
...
import { SVGLine } from "../launches/launches.component";
import { GlobalSettings } from "../settings/global.settings";
import { ApprovedAppsComponent } from "../approved-apps/approved-apps.component";
export const SettingsPopup = (props) => {
    ...
    const showLogout = !url.get('onboarding') || ((_a = user === null || user === void 0 ? void 0 : user.tier) === null || _a === void 0 ? void 0 : _a.current) === 'FREE';
    const loadProfile = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        const personal = yield (yield fetch('/user/personal')).json();
    ...
    const submit = useCallback((val) => __awaiter(void 0, void 0, void 0, function* () {
        yield fetch('/user/personal', {
            method: 'POST',
        ...
        toast.show(t('profile_updated', 'Profil mis \u00e0 jour'));
        close();
    }), []);
    ...
    const list = useMemo(() => {
        var _a, _b, _c, _d;
        const arr = [];
        arr.push({ tab: 'global_settings', label: t('global_settings', 'Param\u00e8tres g\u00e9n\u00e9raux') });
        // Populate tabs based on user permissions
        if (((_a = user === null || user === void 0 ? void 0 : user.tier) === null || _a === void 0 ? void 0 : _a.team_members) && isGeneral) {
            arr.push({ tab: 'teams', label: t('teams', '\u00c9quipes') });
        }
        if ((_b = user === null || user === void 0 ? void 0 : user.tier) === null || _b === void 0 ? void 0 : _b.webhooks) {
            arr.push({ tab: 'webhooks', label: t('webhooks_1', 'Webhooks') });
        }
        if ((_c = user === null || user === void 0 ? void 0 : user.tier) === null || _c === void 0 ? void 0 : _c.autoPost) {
            arr.push({ tab: 'autopost', label: t('auto_post', 'Publication auto') });
        }
        if ((user === null || user === void 0 ? void 0 : user.tier.current) !== 'FREE') {
            arr.push({ tab: 'sets', label: t('sets', 'Sets') });
        }
        if ((user === null || user === void 0 ? void 0 : user.tier.current) !== 'FREE') {
            arr.push({ tab: 'signatures', label: t('signatures', 'Signatures') });
        }
        if (((_d = user === null || user === void 0 ? void 0 : user.tier) === null || _d === void 0 ? void 0 : _d.public_api) && isGeneral && showLogout) {
            arr.push({ tab: 'api', label: t('developers', 'D\u00e9veloppeurs') });
        }
        arr.push({ tab: 'approved_apps', label: t('approved_apps', 'Apps approuv\u00e9es') });
        return arr;
    ...
    return (<>
      <div className="bg-newBgColorInner p-[20px] flex flex-col transition-all w-[260px]">
        <div className="flex flex-1 flex-col gap-[15px]">
          {list.map(({ tab: tabKey, label }) => (<div key={tabKey} className={clsx('cursor-pointer flex items-center gap-[12px] group/profile hover:bg-boxHover rounded-e-[8px]', tabKey === tab && 'bg-boxHover')} onClick={() => setTab(tabKey)}>
        ...
        <FormProvider {...form}>
          <form onSubmit={form.handleSubmit(submit)}>
            ...
            <div className={clsx('w-full mx-auto gap-[24px] flex flex-col relative', !getRef && 'rounded-[4px]')}>
              {tab === 'global_settings' && (<div>
                  <GlobalSettings />
                </div>)}
              {tab === 'teams' && !!((_b = user === null || user === void 0 ? void 0 : user.tier) === null || _b === void 0 ? void 0 : _b.team_members) && isGeneral && (<div>
                  <TeamsComponent />
                </div>)}

              {tab === 'webhooks' && !!((_c = user === null || user === void 0 ? void 0 : user.tier) === null || _c === void 0 ? void 0 : _c.webhooks) && (<div>
                  <Webhooks />
                </div>)}

              {tab === 'autopost' && !!((_d = user === null || user === void 0 ? void 0 : user.tier) === null || _d === void 0 ? void 0 : _d.autoPost) && (<div>
                  <Autopost />
                </div>)}

              {tab === 'sets' && (user === null || user === void 0 ? void 0 : user.tier.current) !== 'FREE' && (<div>
                  <Sets />
                </div>)}

              {tab === 'signatures' && (user === null || user === void 0 ? void 0 : user.tier.current) !== 'FREE' && (<div>
                  <SignaturesComponent />
                </div>)}

              {tab === 'api' &&
            !!((_e = user === null || user === void 0 ? void 0 : user.tier) === null || _e === void 0 ? void 0 : _e.public_api) &&
            isGeneral &&
            showLogout && (<div>
                    <PublicComponent />
                  </div>)}

              {tab === 'approved_apps' && (<div>
...
export const SettingsComponent = () => {
    ...
    const openModal = useCallback(() => {
        ...
        settings.openModal({
            children: (<div className="relative flex gap-[20px] flex-col flex-1 rounded-[4px] border border-customColor6 bg-sixth p-[16px] w-[500px] mx-auto">
          <SettingsPopup />
        </div>),
            classNames: {
    ...
    return (<Link href="/settings" onClick={openModal}>
