      ...
      <form onSubmit={form.handleSubmit(callBack)}>
        ...
        setValueAs: (value) => value === 'true' || value === true,
            ...
            {!generateContent && (<>
                ...
                <CopilotTextarea disableBranding={true} className={clsx('!min-h-40 !max-h-80 p-2 overflow-x-hidden scrollbar scrollbar-thumb-[#E8243C] bg-customColor2 outline-none mb-[16px] border-fifth border rounded-[4px]')} value={content} onChange={(e) => {
