      ...
      <div className="bg-newBgColorInner rounded-[12px] p-[20px] border border-newTableBorder">
        ...
        <div className="flex gap-[12px] items-end">
          ...
          <button
            type="button"
            onClick={addHour}
            className="h-[42px] px-[16px] bg-[#E8243C] hover:bg-[#C41D32] transition-colors rounded-[8px] flex items-center gap-[6px] text-white text-[14px] font-medium"
          >
            <PlusIcon size={14} />
            {t('add', 'Add')}
          </button>
            ...
            {times.map((timeSlot, index) => (
              <div
                ...
                className={clsx(
                  ...
                  'hover:border-[#E8243C]/40 transition-colors'
                )}
              >
