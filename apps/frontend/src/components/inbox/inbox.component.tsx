            ...
            {filtered.map((msg) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 border-b border-white/5 hover:bg-white/5 transition-colors ${
                  selectedId === msg.id ? 'bg-[#00D4AA]/5 border-l-2 border-l-[#00D4AA]' : ''
                }`}
              >
              ...
              <>
                ...
                <div className="p-4 border-t border-white/5">
                  <textarea
                    ...
                    placeholder="C'est magnifique ! Comment faire pour réserver ? Ne a rait commentarier comment faire pour réserver ?!"
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder:text-white/20 focus:outline-none focus:border-[#00D4AA]/50 resize-none h-[60px]"
                  />
