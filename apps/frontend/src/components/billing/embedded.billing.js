...
import { PaymentElement, CheckoutProvider, useCheckout, } from '@stripe/react-stripe-js/checkout';
import { modeEmitter } from "../layout/mode.component";
...
export const EmbeddedBilling = ({ stripe, secret, showCoupon = false, autoApplyCoupon }) => {
    ...
    return (<div className="flex flex-col w-full pt-[48px] billing-form flex-1 tablet:pt-0">
...
const FormWrapper = ({ showCoupon = false, autoApplyCoupon, }) => {
    ...
    const handleSubmit = (e) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const confirmResult = yield checkout.confirm();
        if (confirmResult.type === 'error') {
            toaster.show(confirmResult.error.message, 'warning');
        }
        setLoading(false);
    });
    return (<form onSubmit={handleSubmit} className="flex flex-col flex-1">
      <StripeInputs showCoupon={showCoupon} autoApplyCoupon={autoApplyCoupon} loading={loading}/>
    </form>);
};
const StripeInputs = ({ showCoupon, autoApplyCoupon, loading }) => {
    ...
    return (<>
      ...
      <div>
        ...
        {checkout.type === 'loading' ? null : (<div className="mt-[24px] text-[16px] font-[600] flex gap-[4px] items-center">
            <div>
...
const PriceBreakdown = () => {
    ...
    const { checkout } = checkoutState;
    const lineItem = (_a = checkout === null || checkout === void 0 ? void 0 : checkout.lineItems) === null || _a === void 0 ? void 0 : _a[0];
    const recurring = checkout === null || checkout === void 0 ? void 0 : checkout.recurring;
    const discountAmounts = checkout === null || checkout === void 0 ? void 0 : checkout.discountAmounts;
    const hasDiscount = discountAmounts && discountAmounts.length > 0;
    // Get values
    const planName = (lineItem === null || lineItem === void 0 ? void 0 : lineItem.name) || t('billing_subscription', 'Subscription');
    const unitAmount = ((_b = lineItem === null || lineItem === void 0 ? void 0 : lineItem.unitAmount) === null || _b === void 0 ? void 0 : _b.amount) || '$0.00';
    const discountDisplay = hasDiscount ? discountAmounts[0] : null;
    const dueToday = ((_d = (_c = checkout === null || checkout === void 0 ? void 0 : checkout.total) === null || _c === void 0 ? void 0 : _c.total) === null || _d === void 0 ? void 0 : _d.amount) || '$0.00';
    const nextBillingTotal = (_f = (_e = recurring === null || recurring === void 0 ? void 0 : recurring.dueNext) === null || _e === void 0 ? void 0 : _e.total) === null || _f === void 0 ? void 0 : _f.amount;
    const nextBillingDate = ((_g = recurring === null || recurring === void 0 ? void 0 : recurring.trial) === null || _g === void 0 ? void 0 : _g.trialEnd)
        ? dayjs(recurring.trial.trialEnd * 1000).format('MMMM D, YYYY')
        : null;
    const billingInterval = (recurring === null || recurring === void 0 ? void 0 : recurring.interval) === 'month'
    ...
    return (<div className="mt-[40px]">
      ...
      <div className="rounded-[12px] border border-newColColor p-[20px] flex flex-col gap-[12px]">
        ...
        {/* Discount */}
        {discountDisplay && (<div className="flex justify-between items-center font-[600]">
        ...
        {/* Next billing info */}
        {nextBillingTotal && nextBillingDate && (<div className="flex justify-between items-center text-[13px] text-textColor/60">
            <span>
...
const AppliedCouponDisplay = ({ appliedCode, checkout, isApplying, onRemove }) => {
    const t = useT();
    // Get discount display from checkout state
    const getDiscountDisplay = () => {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        // Try to get percentage from discountAmounts
        const percentOff = (_b = (_a = checkout === null || checkout === void 0 ? void 0 : checkout.discountAmounts) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.percentOff;
        if (percentOff && typeof percentOff === 'number' && percentOff > 0) {
            return `-${percentOff}%`;
        }
        // Try to get actual discount amount from recurring.dueNext.discount
        const recurringDiscount = (_e = (_d = (_c = checkout === null || checkout === void 0 ? void 0 : checkout.recurring) === null || _c === void 0 ? void 0 : _c.dueNext) === null || _d === void 0 ? void 0 : _d.discount) === null || _e === void 0 ? void 0 : _e.minorUnitsAmount;
        ...
        const lineItemDiscount = (_j = (_h = (_g = (_f = checkout === null || checkout === void 0 ? void 0 : checkout.lineItems) === null || _f === void 0 ? void 0 : _f[0]) === null || _g === void 0 ? void 0 : _g.discountAmounts) === null || _h === void 0 ? void 0 : _h[0]) === null || _j === void 0 ? void 0 : _j.percentOff;
        if (lineItemDiscount &&
    ...
    const getExpirationDate = () => {
        ...
        const discount = (_a = checkout === null || checkout === void 0 ? void 0 : checkout.discountAmounts) === null || _a === void 0 ? void 0 : _a[0];
        const lineItemDiscount = (_d = (_c = (_b = checkout === null || checkout === void 0 ? void 0 : checkout.lineItems) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.discountAmounts) === null || _d === void 0 ? void 0 : _d[0];
        // Check for expiresAt in various locations (Unix timestamp)
        const expiresAt = (discount === null || discount === void 0 ? void 0 : discount.expiresAt) ||
            (discount === null || discount === void 0 ? void 0 : discount.expires_at) ||
            (lineItemDiscount === null || lineItemDiscount === void 0 ? void 0 : lineItemDiscount.expiresAt) ||
            (lineItemDiscount === null || lineItemDiscount === void 0 ? void 0 : lineItemDiscount.expires_at) ||
            ((_e = checkout === null || checkout === void 0 ? void 0 : checkout.promotionCode) === null || _e === void 0 ? void 0 : _e.expiresAt) ||
            ((_f = checkout === null || checkout === void 0 ? void 0 : checkout.promotionCode) === null || _f === void 0 ? void 0 : _f.expires_at);
      ...
      <div className="flex items-center gap-[12px] p-[16px] rounded-[12px] border border-[#AA0FA4]/30 bg-[#AA0FA4]/10">
        <div className="flex-1">
          <div className="flex items-center gap-[8px] flex-wrap">
            ...
            <span className="font-[600] text-[#00D4FF]">{appliedCode}</span>
        ...
        <button type="button" onClick={onRemove} disabled={isApplying} className="text-[14px] text-textColor/50 hover:text-textColor font-[500] disabled:opacity-50">
          {t('billing_remove', 'Remove')}
        </button>
      </div>
      {expirationDate && (<p className="text-[13px] text-textColor/50 flex items-center gap-[6px]">
...
export const CouponInput = ({ autoApplyCoupon, }) => {
    var _a, _b;
    const checkoutState = useCheckout();
    const t = useT();
    const toaster = useToaster();
    ...
    const preAppliedCode = (_b = (_a = checkout === null || checkout === void 0 ? void 0 : checkout.discountAmounts) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.promotionCode;
    const effectiveAppliedCode = appliedCode || preAppliedCode || null;
    const handleApplyCoupon = (e, coupon) => __awaiter(void 0, void 0, void 0, function* () {
        if (!coupon && !couponCode.trim())
            return;
        setIsApplying(true);
        try {
            const result = yield checkout.applyPromotionCode(coupon || couponCode.trim());
            if (result.type === 'error') {
                toaster.show(result.error.message ||
                    t('billing_invalid_coupon', 'Invalid coupon code'), 'warning');
            }
            else {
    ...
    const handleRemoveCoupon = () => __awaiter(void 0, void 0, void 0, function* () {
        setIsApplying(true);
        try {
            yield checkout.removePromotionCode();
            setAppliedCode(null);
            toaster.show(t('billing_coupon_removed', 'Coupon removed'), 'success');
        }
        catch (err) {
            toaster.show(err.message ||
                t('billing_error_removing_coupon', 'Error removing coupon'), 'warning');
        }
        setIsApplying(false);
    });
    ...
    if (!showInput) {
        return (<div className="mt-[40px]">
        <button type="button" onClick={() => setShowInput(true)} className="text-[16px] text-textColor/60 hover:text-textColor font-[500] flex items-center gap-[8px] transition-colors">
    ...
    return (<div className="mt-[40px]">
      ...
      <div className="flex gap-[12px]">
        <input type="text" value={couponCode} onChange={(e) => setCouponCode(e.target.value)} placeholder={t('billing_enter_coupon_code', 'Enter coupon code')} disabled={isApplying} autoFocus className="flex-1 h-[44px] px-[16px] rounded-[8px] border border-newColColor bg-newBgColor text-textColor placeholder:text-textColor/50 focus:outline-none focus:border-boxFocused disabled:opacity-50" onKeyDown={(e) => {
            if (e.key === 'Enter') {
                e.preventDefault();
                handleApplyCoupon();
            }
        ...
        <button type="button" onClick={() => handleApplyCoupon()} disabled={isApplying || !couponCode.trim()} className="h-[44px] px-[24px] rounded-[8px] bg-boxFocused text-textItemFocused font-[600] hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all">
          {isApplying
...
const SubmitBar = ({ loading }) => {
    ...
    return (<div className="animate-fadeIn h-[92px] mobile:h-auto fixed bottom-0 w-full px-[12px] pb-[12px] left-0 bg-newBgColor z-[100]">
      <div className="w-full h-full border-t border-newColColor bg-newBgColorInner px-[80px] tablet:px-[33px] mobile:!px-[16px] flex mobile:flex-col gap-[32px] mobile:gap-[16px] justify-end items-center font-[400] text-[14px] text-[#A3A3A3] mobile:py-[16px]">
        {((_b = (_a = checkout.checkout.recurring) === null || _a === void 0 ? void 0 : _a.trial) === null || _b === void 0 ? void 0 : _b.trialEnd) ? (<div>
            ...
            <span className="text-textColor font-[600]">
              {dayjs(((_d = (_c = checkout.checkout.recurring) === null || _c === void 0 ? void 0 : _c.trial) === null || _d === void 0 ? void 0 : _d.trialEnd) * 1000).format('MMMM D, YYYY')}{' '}
              —{' '}
            </span>
            <span className="text-textColor font-[600]">
        ...
        <div>
          <Button className="h-[42px] rounded-[10px] mobile:w-full" type="submit" loading={loading}>
            {((_f = (_e = checkout.checkout.recurring) === null || _e === void 0 ? void 0 : _e.trial) === null || _f === void 0 ? void 0 : _f.trialEnd)
...
//# sourceMappingURL=embedded.billing.js.map