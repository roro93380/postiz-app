...
export const InstagramPreview = (props) => {
    ...
    const renderContent = topValue.map((p) => {
        ...
        const finalValue = `<strong class="text-[15px] font-[600]">${integration === null || integration === void 0 ? void 0 : integration.name} </strong>` +
            newContent
                .slice(start, end)
    ...
    return (<div className="py-[10px] flex flex-col px-[15px] w-full gap-[10px] bg-bgInstagram rounded-[12px]">
              ...
              <div className="flex gap-[10px] leading-[17px]">
                ...
                <div className="flex flex-col gap-[6px] flex-1">
                  <div className="flex gap-[4px] py-[8px]">
                    <div className="whitespace-pre-line text-[14px] font-[400] flex-1" dangerouslySetInnerHTML={{
                    __html: value.text,
                }}/>
                    <div>
...
//# sourceMappingURL=instagram.preview.js.map