...
export const YoutubePreview = (props) => {
    ...
    return (<div className="absolute left-0 top-0 gap-[12px] w-full h-full flex flex-col p-[16px] bg-bgYoutube">
      <div style={{ background: 'url(/no-video-youtube.png)' }} className="!bg-cover w-full aspect-[calc(16/9)] rounded-[4px] overflow-hidden">
      ...
      <div className="flex items-center">
        <div className="flex flex-1 gap-[17px] items-center">
          <div>
            <img src={(integration === null || integration === void 0 ? void 0 : integration.picture) || '/no-picture.jpg'} alt="social" className="rounded-full z-[2] w-[40px] h-[40px]"/>
          </div>
