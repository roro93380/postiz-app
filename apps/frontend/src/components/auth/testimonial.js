...
export const Testimonial = ({ content, description, name, picture }) => {
    return (<div className="rounded-[16px] w-full flex flex-col gap-[16px] p-[20px] bg-[#141414] border border-[#2b2a2a]">
      {/* Header */}
