...
export const AutomationBuilder: FC = () => {
  ...
  return (
    <div className="bg-newBgColorInner flex-1 flex-col flex p-6 gap-5">
      {/* Header */}
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center gap-2 flex-1 min-w-0">
                    ...
                    {rule.hasAi && (
                      <span className="text-[9px] px-1.5 py-0.5 bg-gradient-to-r from-[#E8243C] to-[#00D4AA] rounded text-white font-bold flex-shrink-0">
                        IA
                      </span>
                    )}
                  </div>
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <div
                      ...
                      className={`w-8 h-4 rounded-full transition-all relative cursor-pointer ${
                        rule.active ? 'bg-[#00D4AA]' : 'bg-white/20'
                      }`}
                    >
